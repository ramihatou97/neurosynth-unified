...
from typing import List, Set, Optional, Iterator, Any
...
class UMLSExtractor:
    ...
    def extract(self, text: str) -> List[UMLSEntity]:
        """
...
_default_extractor: Optional[UMLSExtractor] = None


def get_default_extractor() -> UMLSExtractor:
    """Get or create the default UMLS extractor singleton."""
    global _default_extractor
    if _default_extractor is None:
        _default_extractor = UMLSExtractor()
